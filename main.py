...
#    #khoi tao listitem, va ma tran danh gia
    listItem=ReadFile.getItem("D:/danthanh/DoAnTotNghiep/datasets/ml-100k/u.item");
    listUser=ReadFile.getUser("D:/danthanh/DoAnTotNghiep/datasets/ml-100k/u.user");
    ...
    GroupByCategory,GroupByMovies=ReadFile.getMovies_Genres("D:/danthanh/DoAnTotNghiep/datasets/ml-100k/u.item")
...
############################### MF   #####################################
    ...
    print (userRecommedMF)
     ...
     #Re call
    relItem=recall.relItem(urm,user)
    ...
    listRecommedNewDiversity=dadang.IncreasingDiversity(urm,user,userRecommedMF,listRel,topN,alpha,loaiDadang);
...
#####################       user-base UB   ############################
    ...
    listRecommedNewDiversity=dadang.IncreasingDiversity(urm,user,userRecommedKNN_UB,listRel,topN,alpha,loaiDadang);
    dd=dadang.Diversity(urm,None,listRecommedNewDiversity,loaiDadang)
    print ("Danh sach goi y khi tang da dang: ",listRecommedNewDiversity)
    print("Do da dang sau khi tang",dd)
